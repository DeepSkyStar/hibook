...
> ⚠️ **强烈致所有后续开发者与代码贡献者:**  
> 在对本仓库撰写任何修改性质的代码之前，您**必须首先拜读 [DEV_GUIDE.md](./DEV_GUIDE.md)**。它严密地收买了诸如多租户物理沙盒的泄漏陷阱、Python `subprocess` 命令工作区虚拟化的铁律法则，以及绝对致命的 Webview 本地模态框死锁等核心规范，一旦被疏忽必将导致底层多路后台架构的解体崩塌！
